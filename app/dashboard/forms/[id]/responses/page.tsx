...
export default function ResponsesPage({ params }: ResponsesPageProps) {
  ...
  // ----- Render guards --------------------------------------------------
  if (isLoading) {
    // Skeleton: header strip + toolbar strip + table strip — keeps the
    // post-load layout shape so content doesn't jump in.
    return (
      <div
        role="status"
      ...
      >
        <div className="flex flex-col gap-4">
          <div className="h-12 animate-pulse rounded-xl border border-gray-200 bg-white shadow-sm" />
          <div className="h-12 animate-pulse rounded-xl border border-gray-200 bg-white shadow-sm" />
